...
cmd(
  {
    ...
    alias: ["wallpaper"],
    react: "🖼️",
    desc: "DOWNLOAD HD WALLPAPERS | ALFHA X MD",
    category: "download",
    filename: __filename,
  },
  async (
    ...
    try {
      ...
      await conn.sendMessage(
        ...
        {
          image: {
            url: "https://res.cloudinary.com/dhpfn4umb/image/upload/v1768786477/kxbzudmkwjpwv2if1ge6.png",
          },
          caption: header,
        },
        { quoted: mek }
...
`;
      ...
      return reply("*🌟 Enjoy your HD wallpapers! Thank you for using ALFHA  X MD.*");
    } catch (e) {
      console.error(e);
